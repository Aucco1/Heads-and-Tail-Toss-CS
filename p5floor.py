...
df = pd.read_excel(file_path, sheet_name='#5 TILES', header=None)
...
fig.suptitle('Requirement #5: TILES Surface - All Coin Classes', fontsize=24, fontweight='bold', color='#333333')
axes = axes.flatten()
